...
export const StudentCard = memo(function StudentCard({ student, colorHex }: StudentCardProps) {
  ...
  if (words.length >= 2) {
    ...
    // Si solo tiene una palabra, ponerla en la primera línea
    colegioLine1 = fullSchoolName;
    colegioLine2 = '';
  }
  
  // Asegurar que siempre haya dos líneas
  if (!colegioLine2 || colegioLine2.trim() === '') {
    colegioLine2 = colegioLine1;
    colegioLine1 = fullSchoolName;
  }
